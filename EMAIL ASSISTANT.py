...
class Dlib_Face_Unlock:
    ...
    def __init__(self):
        ...
        try:
            ...
            # the service
            with open(r'C:\Users\ADMIN\PycharmProjects\CommunityProjects\labels.pickle', 'rb') as self.f:
        ...
        if self.labels_ids != self.og_labels:
            ...
            with open(r'C:\Users\ADMIN\PycharmProjects\CommunityProjects\KnownFace.pickle', 'rb') as self.faces_file:
...
tk.Label(loginFrame, text="Face Recognition", font=("Times New Roman", 60), bg="white").grid(row=1, column=1, columnspan=5)
...
subm1.add_command(label="Python")
subm1.add_command(label="Facial Recognition")
subm1.add_command(label="Speech Recognition")
subm1.add_command(label="SMTP")
subm1.add_command(label="Spam Detection")
